...
const ProductsPage = () => {
  ...
  const handleDelete = async (product: IProduct) => {
    try {
      ...
      setProducts(products.filter(p => p._id.toString() !== product._id.toString()))
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div>
              ...
              >
                ...
                {categories.map(cat => (
                  <option key={cat._id.toString()} value={cat.slug}>{cat.name}</option>
                ))}
              </select>
            </div>
                  ...
                  <tr key={product._id.toString()} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2">
                        <button
                          onClick={() => router.push(`/admin/products/${product._id.toString()}`)}
